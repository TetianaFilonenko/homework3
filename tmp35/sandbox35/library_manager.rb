...
The most popular author is #{most_popular_author['author_name']}: #{most_popular_author['pages']} pages has been read in #{most_popular_author['books']} books by #{most_popular_author['readers'].count} readers.
