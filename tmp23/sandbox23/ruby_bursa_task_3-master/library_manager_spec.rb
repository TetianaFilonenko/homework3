...
describe LibraryManager do
  ...
  let!(:ivan_testenko) { 
    ReaderWithBook.new(war_and_peace, ivan, 328, (DateTime.now.new_offset(0) + 2.days)) 
  }
...
TEXT
  ...
  xit 'should compose librarian notification' do
...
TEXT
  ...
  xit 'should compose statistics notification' do
