...
manager=LibraryManager.new([],[], [ivan_testenko])
    ...
    manager.new_reader('Vitaly Klychko', 22)
    manager.new_reader('Zina', 3)
    manager.new_reader('Yulia Testova', 25)
    ...
    manager.give_book_to_reader('Yulia Testova','Ruby for Rails') 
    manager.read_the_book('Vasiliy Pupkin',30)
    manager.read_the_book('Barak Obama',7)
    manager.read_the_book('Yulia Testova',12)
